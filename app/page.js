...
{/* Header */}
      <div style={{ background: 'white', borderBottom: '1px solid #e2e8f0', padding: '6px 40px', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '16px', boxShadow: '0 1px 8px rgba(31,78,121,0.08)' }}>
